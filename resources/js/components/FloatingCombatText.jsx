 ...
 * mostrado sobre el personaje afectado (según quién ataca a quién) justo después
 * del golpe de energía. Salta al aparecer y se desvanece flotando hacia arriba;
 * se desmonta solo tras FLOAT_TEXT_MS, sin verse interrumpido por otro texto que
 * aparezca mientras tanto (cada instancia gestiona su propio timer).
 */
