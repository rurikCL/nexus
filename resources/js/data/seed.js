/* NÉXUS — datos semilla (MOCK).
  ...
  const CLASSES = [
    { id: 'vanguardia', name: 'Vanguardia', desc: 'Asalto frontal · presión de hoja', icon: 'shield', accent: '#FF6B00' },
    { id: 'espectro',   name: 'Espectro',   desc: 'Fintas y precisión · golpe crítico', icon: 'ghost',  accent: '#38cdf0' },
    { id: 'titan',      name: 'Titán',      desc: 'Guardia férrea · control de distancia', icon: 'anvil',  accent: '#8b5cf6' },
    { id: 'oraculo',    name: 'Oráculo',    desc: 'Anticipa la hoja · lectura del duelo',  icon: 'eye',    accent: '#10b981' },
  ];
  ...
  const combatants = [
    { id: 'you',  name: 'Valentina Soto',  handle: 'V-SOTO', initials: 'VS', color: '#FF6B00',
      cls: 'vanguardia', wins: 34, losses: 11, streak: 4, credits: 4250, gold: true,
      stats: { fuerza: 78, velocidad: 64, tecnica: 71, defensa: 58, foco: 82 },
      medals: ['oro-temporada-3', 'racha-10', 'invicto-novato'], bio: 'Cierro distancias antes de que respires. Vanguardia pura.',
      sector: 'Sector Andes', sponsor: 'Banco Estado', joined: '2024' },
    { id: 'c2',  name: 'Carlos Méndez',   handle: 'C-MNDZ', initials: 'CM', color: '#38cdf0',
      cls: 'espectro', wins: 41, losses: 9, streak: 7, credits: 6120, gold: true,
    ...
    { id: 'c3',  name: 'María González',  handle: 'M-GNZL', initials: 'MG', color: '#8b5cf6',
      cls: 'titan', wins: 28, losses: 14, streak: 2, credits: 3380, gold: false,
    ...
    { id: 'c4',  name: 'Diego Fuentes',   handle: 'D-FNTS', initials: 'DF', color: '#10b981',
      cls: 'oraculo', wins: 52, losses: 6, streak: 11, credits: 9870, gold: true,
    ...
    { id: 'c5',  name: 'Javiera Rojas',   handle: 'J-ROJS', initials: 'JR', color: '#ec4899',
      cls: 'espectro', wins: 19, losses: 17, streak: 0, credits: 1540, gold: false,
    ...
    { id: 'c6',  name: 'Tomás Bravo',     handle: 'T-BRVO', initials: 'TB', color: '#f97316',
      cls: 'vanguardia', wins: 12, losses: 20, streak: 0, credits: 720, gold: false,
    ...
    { id: 'c7',  name: 'Ignacia Lillo',   handle: 'I-LILO', initials: 'IL', color: '#38cdf0',
      cls: 'oraculo', wins: 7, losses: 9, streak: 1, credits: 410, gold: false,
    ...
    { id: 'c8',  name: 'Felipe Araya',    handle: 'F-ARYA', initials: 'FA', color: '#8b5cf6',
      cls: 'titan', wins: 3, losses: 6, streak: 0, credits: 180, gold: false,
