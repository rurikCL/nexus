...
const NAV = [
  ...
  { id: 'misiones', label: 'Misiones', icon: 'zap' },
...
const TITLES = {
  ...
  misiones: ['Misiones', 'Misiones de comunidad e individuales'],
...
export default function App({ user, onLogout, onUserUpdate, onTransmision }) {
  ...
  useEffect(() => {
    ...
    S.setCharacter({
      ...
      vida:           baseCombat.vida       ?? ch.vida       ?? 8,
      escudo:         baseCombat.escudo     ?? ch.escudo     ?? 4,
      defensa:        baseCombat.defensa    ?? ch.defensa    ?? 2,
      ataque:         baseCombat.ataque     ?? ch.ataque     ?? 2,
      movimiento:     baseCombat.movimiento ?? ch.movimiento ?? 2,
      iniciativa:     baseCombat.iniciativa ?? ch.iniciativa ?? 2,
      punteria:       baseCombat.punteria   ?? ch.punteria   ?? 2,
      combat_stats:   combat,
      ...
      arma_equipada: ch.arma_equipada ?? null,
  ...
  const VIEWS = {
    ...
    'armado-sable': <ArmadoSableView user={user} onUserUpdate={onUserUpdate} go={go} />,
  };
