...
const ENTITY_CONFIG = {
  ...
  npcs: {
    ...
    fields: [
      ...
      { key: 'nivel',         label: 'Nivel (★)',        type: 'number', min: 0, hint: 'Nivel de dificultad (1-5), representado con estrellas. Suma +1 a todos sus atributos por nivel sobre el 1 (nivel 1 = +0, nivel 5 = +4; incluye vida y escudo, este último topado en 5), y ese mismo bono se suma al daño base de un ataque normal (ver Daño/Daño a Escudo/Daño Perforante más abajo). Crítico: nivel 1-3 por "dobles" en 2d6 (más probable cuanto más alto el nivel); nivel 4 → un dado en 6 y el otro 5+; nivel 5 → un dado en 6 y el otro 4+. Un golpe crítico siempre suma +1 de daño plano. Si es Jefe, todo esto además aplica en Combate RAID.' },
  ...
  rol_objetos: {
    ...
    fields: [
      ...
      { key: 'bono_dano_perforante', label: 'Bono Daño Perforante', type: 'number', min: -999, hint: 'Se suma al daño perforante del sable (ignora el escudo, pasa directo a la vida)' },
  ...
  usuarios: {
    ...
    columns: [
      ...
      { key: 'sede', label: 'Sede', resolve: r => r.sede?.nombre ?? '—', dim: true },
    ...
    fields: [
      ...
      { key: 'sede_id',  label: 'Sede',   type: 'relatedSelect', related: 'sedes' },
  ...
  misiones: {
    label: 'Misiones', icon: 'target', group: 'ROL',
    custom: true,
  },
