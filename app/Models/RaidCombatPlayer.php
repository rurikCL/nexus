...
class RaidCombatPlayer extends Model
{
    ...
    protected $fillable = [
        ...
        'cooldowns', 'buffs', 'debuffs', 'estados', 'dano_al_jefe', 'agro_puntos',
        'curacion_total', 'debuffs_aplicados', 'recompensas_otorgadas', 'status', 'listo',
    ];
